									...
									<div class="dash-info-list">
										<div class="dash-card">
											<div class="dash-card-container">
												...
												<div class="dash-card-content">
													<p>Fresher will join on Thursday</p>
												</div>
												<div class="dash-card-avatars">
													<div class="e-avatar"><img src="assets/img/profiles/avatar-20.jpg" alt=""></div>
												</div>
											</div>
										</div>
									</div>
									<div class="dash-info-list">
										<a href="" class="dash-card">
											<div class="dash-card-container">
												...
												<div class="dash-card-content">
													<p>It's Mahashivarathri Holiday  on Monday</p>
												</div>
											</div>
										</a>
									</div>
								...
								<section>
									...
									<div class="card">
										<div class="card-body text-center">
											<h4 class="holiday-title mb-0">Mon 23 Jun 2023 - Raksha Bandhan</h4>
										</div>
									</div>
								</section>
							</div>
