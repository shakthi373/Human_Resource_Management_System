							...
							<div class="card-group m-b-30">
								<div class="card">
									<div class="card-body">
										...
										<p class="mb-0">Overall Employees 219</p>
									</div>
								</div>
								...
								<div class="card">
									<div class="card-body">
										...
										<h3 class="mb-3">₹1,18,43,130</h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<p class="mb-0">Previous Month <span class="text-muted">₹96,41,956</span></p>
									</div>
								</div>
								...
								<div class="card">
									<div class="card-body">
										...
										<h3 class="mb-3">₹7,07,425</h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<p class="mb-0">Previous Month <span class="text-muted">₹6,24,198</span></p>
									</div>
								</div>
								...
								<div class="card">
									<div class="card-body">
										...
										<h3 class="mb-3">₹22,01,174</h3>
										<div class="progress mb-2" style="height: 5px;">
											<div class="progress-bar bg-primary" role="progressbar" style="width: 70%;" aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"></div>
										</div>
										<p class="mb-0">Previous Month <span class="text-muted">₹18,93,009</span></p>
									</div>
								</div>
							</div>
						</div>	
