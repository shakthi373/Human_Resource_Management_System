						...
						<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<p class="text-muted">Venkatesh is simply dummy text of the printing and typesetting industry.
									...
									<div class="project-members m-b-15">
										...
										<ul class="team-members">
											<li>
												<a href="#" data-toggle="tooltip" title="Abhishek"><img alt="" src="assets/img/profiles/avatar-16.jpg"></a>
											</li>
										</ul>
									</div>
									<div class="project-members m-b-15">
										...
										<ul class="team-members">
											<li>
												<a href="#" data-toggle="tooltip" title="Abhay"><img alt="" src="assets/img/profiles/avatar-02.jpg"></a>
											</li>
											<li>
												<a href="#" data-toggle="tooltip" title="Abhijit"><img alt="" src="assets/img/profiles/avatar-09.jpg"></a>
											</li>
											<li>
												<a href="#" data-toggle="tooltip" title="Abhinav"><img alt="" src="assets/img/profiles/avatar-10.jpg"></a>
											</li>
											<li>
												<a href="#" data-toggle="tooltip" title="Balu"><img alt="" src="assets/img/profiles/avatar-05.jpg"></a>
											</li>
									...
									<p class="m-b-5">Progress <span class="text-success float-right">77%</span></p>
									<div class="progress progress-xs mb-0">
										<div class="progress-bar bg-success" role="progressbar" data-toggle="tooltip" title="77%" style="width: 77%"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<p class="text-muted">Abhijith just scheduled a meeting about minor
										mistake happens in app.and other code error.
										(on 13:00 PM).
									...
									<p class="m-b-5">Progress <span class="text-success float-right">83%</span></p>
									<div class="progress progress-xs mb-0">
										<div class="progress-bar bg-success" role="progressbar" data-toggle="tooltip" title="83%" style="width: 83%"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<p class="text-muted">Venkatesh is simply dummy text of the printing and
									...
									<p class="m-b-5">Progress <span class="text-success float-right">53%</span></p>
									<div class="progress progress-xs mb-0">
										<div class="progress-bar bg-success" role="progressbar" data-toggle="tooltip" title="53%" style="width: 53%"></div>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
							<div class="card">
								<div class="card-body">
									...
									<p class="m-b-5">Progress <span class="text-success float-right">92%</span></p>
									<div class="progress progress-xs mb-0">
										<div class="progress-bar bg-success" role="progressbar" data-toggle="tooltip" title="92%" style="width: 92%"></div>
									</div>
								</div>
							</div>
						</div>
											...
											<div class="row staff-grid-row">
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Girish</a></h5>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Bhoomika</a></h5>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Sneha</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Roma</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">SriRaj</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">BalRam</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Nikitha</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
												...
												<div class="col-md-4 col-sm-6 col-12 col-lg-4 col-xl-3">
													<div class="profile-widget">
														...
														<h5 class="user-name m-t-10 mb-0 text-ellipsis"><a href="client-profile.php">Arun</a></h5>
														<div class="small text-muted">CEO</div>
														<a href="chat.php" class="btn btn-white btn-sm m-t-10">Message</a>
														<a href="client-profile.php" class="btn btn-white btn-sm m-t-10">View Profile</a>
													</div>
