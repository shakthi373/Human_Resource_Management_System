								...
								<form method="POST">
									...
									<div class="row">
										<div class="col-sm-3">
											<div class="form-group">
												<label>Rate</label>
												<input name="rate" placeholder="" class="form-control" type="text">
											</div>
										</div>
										<div class="col-sm-3">
											<div class="form-group">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="project-members">
													<a href="#" data-toggle="tooltip" title="Abhay" class="avatar">
									...
									<div class="row">
										...
										<div class="col-sm-6">
											<div class="form-group">
												...
												<div class="project-members">
													<a href="#" data-toggle="tooltip" title="Rachith" class="avatar">
														<img src="assets/img/profiles/avatar-24.jpg" alt="">
													</a>
													<a href="#" data-toggle="tooltip" title="Richard" class="avatar">
														<img src="assets/img/profiles/avatar-15.jpg" alt="">
													</a>
													<a href="#" data-toggle="tooltip" title="Abhinav" class="avatar">
														<img src="assets/img/profiles/avatar-18.jpg" alt="">
													</a>
													<a href="#" data-toggle="tooltip" title="Balu" class="avatar">
